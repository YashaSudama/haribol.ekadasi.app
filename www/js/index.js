...
function inner_get_info_func( index_get_info_new, slug, height_header ) {
    ...
    if (array_location_user_length >= 2) {
        country_user = array_location_user_length === 2 ? 
                       array_location_user[1] : array_location_user_length === 3 ? 
                       array_location_user[2] : '';
    };
            ...
            if ( +now_date_local <= +date_event ) {
                ...
                if ( typeof( value_key ) === 'object' ) {
                    ...
                    let exit_date,                      
                        ...
                        month_days_local = get_month_days( now_month, now_year ),
